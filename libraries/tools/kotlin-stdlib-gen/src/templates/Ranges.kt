...
object RangeOps : TemplateGroupBase() {
    ...
    val f_contains = fn("contains(value: Primitive)").byTwoPrimitives {
        ...
        if (rangeType.isIntegral() != itemType.isIntegral()) {
            deprecate(Deprecation("This `contains` operation mixing integer and floating point arguments has unclear semantics and is going to be removed.", level = DeprecationLevel.WARNING))
        }
